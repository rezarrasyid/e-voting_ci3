            ...
            <div class="card-body">
                ...
                <form method="post" action="">
                    <div class="mb-3">
                        ...
                        <input type="text" id="disabledTextInput" fdprocessedid="dr8a6" class="form-control" id="nis" name="nis" placeholder="Masukkan NIS" value="<?= $siswa->NIS ?>" required>
                    </div>
                    <div class="mb-3">
                        <label for="nama" class="form-label">Nama Siswa</label>
                        <input type="text" class="form-control" id="nama" name="nama_siswa" placeholder="Masukkan Nama Siswa" value="<?= $siswa->Nama ?>" required>
                    </div>
                    <div class="mb-3">
                        <label for="kelas" class="form-label">Kelas</label>
                        <select class="form-select" id="kelas" name="kelas" required>
                            <?php foreach ($daftar_kelas as $kelas) { ?>
                                <option value="<?= $kelas->Nama_kelas; ?>" <?= ($siswa->Kelas == $kelas->Nama_kelas) ? 'selected' : ''; ?>><?= $kelas->Nama_kelas; ?></option>
                            <?php } ?>
                        </select>
                    </div>
