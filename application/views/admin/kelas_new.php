...
<body>
    <main class="main">
        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-body">
                    <h1 class="card-title fw-semibold mb-4">Tambah Data Kelas Baru</h1>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <form action="" method="POST" enctype="multipart/form-data">
                                ...
                                <input type="text" class="form-control mb-3" name="nama_kelas" placeholder="Nama Kelas" />
                                <label for="title" class="form-label mb-3">Token</label>
                                <input type="text" class="form-control mb-3" name="token" placeholder="Token Kelas">
                                <div>
